...
public class subtraction_pi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.subtraction_pi);
        ...
        button7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(editTextNumber3.getText().toString().length()==0){
                    ...
                    String s="Oops! Wrong Answer. Correct answer was " + a + " minus " + b +  " = " + ans + ". Don't worry, practice makes a kid perfect. Try this one.";
                    t1.speak(s,TextToSpeech.QUEUE_FLUSH,null);
